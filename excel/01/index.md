...
1.  ![ファイル タブ](pic/filebutton.png) をクリックします
1.  ![開く](pic/open.png) - ![コンピューター](pic/computer.png) - ![参照](pic/sansyo.png) - 目的のブックのあるフォルダに移動します
...
1.  ![名前を付けて保存](pic/newsave.png) - ![コンピューター](pic/computer.png) - ![参照](pic/sansyo.png) の順にクリックします
...
{% screenshot population3a.png "オートフィル2" %}
{% screenshot population3b.png "オートフィル3" %}
...
{% screenshot no7excelint5.gif "印刷プレビュー" %}
