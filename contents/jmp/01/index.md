...
{% screenshot 01_08input.png "体重(kg)列にデータを入力" %}
...
{% screenshot 01_09newline.png "身長(m)列の作成" %}
...
{% screenshot 01_14newline.png "血液型列の作成" %}

&#9315; データを入力します。

{% screenshot 01_15input.png "血液型列にデータを入力" %}
...
{% screenshot 01_17analysis.png "身長(cm), 体重(kg), 身長(m), 血液型をY列に割り当て" %}
