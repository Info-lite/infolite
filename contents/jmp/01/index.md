...
[スタート] - [すべてのプログラム] - [JMP Pro 12] - [JMP Pro 12]と押します。

### データテーブルの新規作成

&#9312; メニューの[ファイル] - [新規作成] - [データテーブル]を押します。
...
&#9312; [列名]（"列1"と書いてあるところ）をダブルクリックします - "身長(cm)"と入力します - [OK]を押します。
...
&#9312; メニューの[列] - [列の新規作成] - [列名]を"体重(kg)"と入力します - [OK]を押します。
...
&#9314; メニューの[列] - [列の新規作成] - [列名]を"身長(m)"と入力します。
...
&#9317; "テーブル列"から[身長(cm)]を選択 - [÷]と押し、分母に"100"を入力して[Enter] - [OK]を押します。

![](./pic/01_11formula.png)

&#9318; 列プロパティで計算式が入力されたことを確認し、[OK]を押します。
...
&#9312; メニューの[列] - [列の新規作成]と押し、[列名]を"血液型"にします。
...
パーセンタイルともいう。 75 %の数字は、 75 パーセンタイルを意味し、その値以下の割合が 75 %となる数値を表します。
25 および 75 パーセンタイルは 4 分位点とも言い、どの値までが全体の何パーセントを占めるかの見当をつけるのに用います。
...
JMPでは不偏分散を指し、偏差（各観測値－平均）を 2 乗することで符号を消し、その合計（偏差平方和）を N－1 で割ったものです。
