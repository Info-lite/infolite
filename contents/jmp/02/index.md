...
テレビ局Aが行った調査によれば、内閣の支持率が 40 %だったとします。
これはそのテレビ局Aが日本国民全体の中から無作為に 2000 人を選出してアンケートを答えてもらった結果、
その 2000 人の中で 40 %の人が内閣を支持したということです。これは決して日本国民全体の支持率ではありません。
しかし、統計的には日本国民全体の支持率と推測できます。

つまり、母集団が日本国民全体となり、標本がアンケートを受けた 2000 人になります。
標本平均が 40 %ですが、母平均はわかりません。それを標本平均によって推測したものが支持率 40 %です。
...
この仮説を退けるためには、この場合、「等しくない」ことが偶然でないことを示すことが必要であり、
...
xは標本平均、&mu; （ミュー）0は母平均、&sigma;（シグマ）は母標準偏差、nは標本数です。
...
よって、p値 = 0.8415 &gt; 有意水準&alpha; = 0.05 であるので、帰無仮説H0は棄却されません。
...
平成 20 年度学校保健統計調査の結果によると、6 歳男児の身長は全国平均（母平均&mu; 0）が 116.7 cmであることが分かっています。
...
なお、は標本平均、sは標本の標準偏差、nは標本数、tn-1(&alpha;)は、自由度n-1のt分布における100×&alpha;%点を示します。
（なお、tn-1(&alpha;)は両側確率&alpha;のｔの臨界値を示すものとする。）
