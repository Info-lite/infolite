...
{% screenshot 03_21t.png "検定統計量$t$値" %}

### 等価自由度 $\varphi$<sup>*</sup>* の算出
...
{% screenshot 03_33t.png "検定統計量$t$値" %}
...
$p$ 値 &ge; 有意水準 $\alpha$ &rarr; 帰無仮説$H_0$を棄却する。
