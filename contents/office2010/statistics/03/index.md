...
-   帰無仮説 H<sub>A</sub> = &mu;<sub>B</sub> C組とD組では平均点に差があるとはいえない
-   対立仮説 H<sub>B</sub> C組とD組では平均点に差がある
...
-   帰無仮説 H<sub>A</sub> = 0 後期の成績は前期の成績より向上しているとはいえない
-   対立仮説 H<sub>A</sub> &gt; 0 後期の成績は前期の成績より向上している
