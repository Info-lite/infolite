...
### クイックアクセスツールバー
![クイックアクセスツールバー](quick.png)

よく使うコマンドを表示しておくことができます。

初期設定では、![](quicksave.png)
（[上書き保存]）、![](quickreturn.png)
（[元に戻す]）、![](quickrepeat.png)
（[繰り返す]）が表示されています。
...
2. [ホーム]リボン - [表示] - ![](layoutview.png)
の（[表示]）の部分をクリックして、[デザインビュー]をクリックします。
![](readinfo3.png)
![](readinfo4.png)


3. デザインビューに切り替わりました。[ホーム]リボン（もしくは[デザイン]リボン） - [表示] - ![](formview.png)
...
2. [ホーム]リボン - [表示] - ![](designview.png)
（[デザイン ビュー]）をクリックしてデザインビューに切り替えます。
![](readcourse3.png)
![](readcourse4.png)


3. デザインビューに切り替わりました。[ホーム]リボン（もしくは[デザイン]リボン） - [表示] - ![](databaseview.png)
...
2. [ホーム]リボン - [表示] - ![](databaseview.png)
の（[表示]）の部分をクリックして、[デザイン ビュー]に切り替えます。
![](readjoin3.png)
![](readjoin4.png)


3. デザインビューに切り替わりました。[ホーム]リボン（もしくは[デザイン]リボン） - [表示] - ![](reportview.png)
（[データベース ビュー]）をクリックすると、元に戻ります。
![](readjoin5.png)
...
2. [外部データ]リボン - [インポート] - ![](excelimport.png)
をクリックします。
![](excelimport1.png)
...
1. [外部データ]タブ - [インポート] - ![](accessimport.png)
をクリックします。
![](accessimport1.png)
