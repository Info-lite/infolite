...
{% screenshot IMEtoolbar1.png "IMEツールバーのオプション" %}

<dl>
<dt>入力モード</dt><dd>ひらがな、カタカナ、英数字の設定変更</dd>
<dt>IMEパッド</dt><dd>特殊文字、難読漢字の入力のアシスト</dd>
<dt>単語の登録</dt><dd>使用頻度の高い単語の登録</dd>
<dt>ユーザー辞書ツール</dt><dd>登録した単語の一覧、編集など</dd>
<dt>追加辞書サービス</dt><dd>オープン拡張辞書の追加、辞書の設定</dd>
<dt>検索機能</dt><dd>検索プロバイダーの追加、設定</dd>
<dt>誤変換レポート</dt><dd>誤変換データのMicrosoftへの報告</dd>
<dt>プロパティ</dt><dd>IMEの詳細設定</dd>
<dt>ローマ字入力/かな入力</dt><dd>キーボードのローマ字、かな文字入力の変更</dd>
<dt>変換モード</dt><dd>漢字(無)変換方式の設定</dd>
<dt>プライベートモード</dt><dd>入力、変換履歴の無効、有効の変更</dd>
<dt>問題のトラブルシューティング</dt><dd>問題があるときのチェック、修復方法の表示</dd>
</dl>
...
IMEツールバー右クリック &rarr; プロパティ &rarr; 詳細設定でダイアログ画面を表示し、設定します。

{% screenshot IMEproperty.png "Microsoft IME のプロパティ詳細設定ダイアログ" %}
