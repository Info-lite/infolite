...
<div>
    ...
    <div class="panel-heading">本講に関する学習動画</div>
        <div class="panel-body">
            <p>本講の授業内容に関する【説明動画】が1つあります。こちらの動画に加えて、サイドメニューの【動画再生】で公開している【図書館とデータベースの利用方法】も必ず視聴してください。</p>
...
<video>
<source type="video/mp4" src="../../../../../lit/video/03_network.mp4">
</video>
</div>
</div>
</div></div>
