...
図書館には、朝日新聞の全文検索など、インターネットで検索できず図書館のPCからのみ利用できるサービスもあります。これらの詳細な使い方は、小冊子「学術情報をオンラインで利用しよう」を活用して下さい。なくした人は図書館で入手できるほか、以下のリンクからPDF版を閲覧できます。
