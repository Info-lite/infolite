...
**本学のコンピュータネットワークシステム（教育研究用情報システム）を使うためには、情報リテラシー実践の授業の中で情報倫理講習を受講する必要があります。**

今回は初回授業となるため、各クラスで担当教員が（補足の）説明をする場合があります。

-   原則、初回の授業に欠席した場合、そのままでは大学のシステムを利用できません。次回の授業前までに、開放利用中の情報処理教室において、チューターに申し出た上で「情報倫理講習会」を受講してください。
-   ただし2021年度の新入生は、新入生ガイダンス（4/2）に配布された「東京都立大学の教育研究用情報システムを使うために（重要）」に記載されたURLにアクセスし、情報倫理講習ビデオを各自で視聴する必要があります。その後、kibacoに設置されたチェックテストに必ず回答してください。
...
-   [ワードプロセッサによる文書編集（１）](../../office2019/word/01/index.html)
-   [ワードプロセッサによる文書編集（２）](../../office2019/word/02/index.html)
    -   [ワードプロセッサによる文書編集（発展例）](../../office2019/word/03/index.html)
    -   [課題提出のための実習時間](../../office2019/word/04/index.html)
...
-   [プレゼンテーションの概要と実習](../../office2019/powerpoint/01/index.html)
    -   [課題提出のための実習時間](../../office2019/powerpoint/02/index.html)
-   [プレゼンテーション実演](../../office2019/powerpoint/03/index.html)
