...
ここでは、Windows10 環境を使用する際の基本操作、サインイン・サインアウトの方法について説明します。Mac 環境の場合は、[Macintosh利用ガイド](http://www.comp.tmu.ac.jp/tmuner/pc/mac_riyou3.html) を参照してください。
...
&#9316; 最後に、右下の Windows ロゴのボタンをクリックして、[サインアウト]を選びます。

{% screenshot logoff1.png "サインアウト" %}

鍵のアイコンのついた方を選んだ場合、「サインアウトしますか？」というダイアログボックスが現れるので、[はい]をクリックします。
...
次回からは、教室にきたらサインイン（サインイン）して、授業前にこのサイトを通読しておいてください。
