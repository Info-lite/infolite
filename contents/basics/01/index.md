...
-   **新入生は、新入生ガイダンスで配布された「東京都立大学の教育研究用情報システムを使うために（重要）」に記載された「情報倫理講習の受講方法」をよく読み、情報倫理講習ビデオを各自で視聴する必要があります。その後、kibacoに設置されたチェックテストに必ず回答してください。**
...
-   授業への積極的な参加、課題や発表、情リテ情報倫理テスト、各種確認テストなどの観点に基づき、総合的に評価します
-   遅刻の扱い、課題や発表の内容および回数を含め、成績評価方法は担当教員により若干異なる場合があります
-   正当な理由なく４回以上欠席した場合は、原則として不合格とします
