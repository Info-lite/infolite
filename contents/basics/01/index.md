...
-   **2022年度の新入生は、新入生ガイダンスで配布された「東京都立大学の教育研究用情報システムを使うために（重要）」に記載された「情報倫理講習の受講方法」をよく読み、情報倫理講習ビデオを各自で視聴する必要があります。その後、kibacoに設置されたチェックテストに必ず回答してください。**
...
この授業のテーマ、目標、計画・内容などについては、必ずシラバスおよび履修の手引きを参照して下さい。ここでは、全体の方針、受講上の注意、成績評価方法、教材について説明します。
...
1.   コンピュータの使い方を理解し、具体的な課題解決の場面において、情報を収集、分析、判断、編集、発信、共有することができる
1.   統計学の基礎を理解し、表計算ソフトによるデータ分析に取り組むことができる
1.   プログラム言語の基本的な文法を理解し、プログラムの作成と読解ができるようになる
1.   情報化社会の特徴を理解し、情報セキュリティ、情報モラル・ルールとマナー、ソーシャルメディア、著作権・肖像権侵害、ネット犯罪の観点からインターネット上での問題に対処する方法を考えることができる
...
-   [【統計】まとめ](../../office2019/statistics/06/index.html)
-   [VBAプログラミング（１）](../../office2019/vba/01/index.html)
-   [VBAプログラミング（２）](../../office2019/vba/02/index.html)
-   [VBAプログラミング（３）](../../office2019/vba/03/index.html)
-   [VBAプログラミング（４）](../../office2019/vba/04/index.html)
-   [【VBAプログラミング】まとめ](../../office2019/vba/05/index.html)
