...
-   成績にかかわる提出・発表は３回程度行います（担当教員によって異なります）
-   このほか、最初の実習課題の提出状況や出席も含め総合的に成績判定します
...
![すべてのプログラム](./pic/notepad01.png)

![アクセサリ](./pic/notepad02.png)

![メモ帳](./pic/notepad03.png)
