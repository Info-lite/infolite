...
{% screenshot mydocument1.png "" %}

これをクリックすると以下のようにマイドキュメントを開くことができます。

{% screenshot mydocument2.png "" %}
