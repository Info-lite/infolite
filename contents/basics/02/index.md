...
&#9312; "TMUNER" にアクセスし、右のメニューから [Webメール] をクリックします。
...
&#9315; ログインすると、次のような受信トレイ画面になります。メール本文を読むときは、件名をクリックします。操作を終える場合は、忘れずに右上の [自分の名前]-[サインアウト] をクリックします。
