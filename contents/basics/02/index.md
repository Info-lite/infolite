...
東京都立大学では、学生のメールアドレスは"姓-名@ed.tmu.ac.jp"（例えばshuto-dai@ed.tmu.ac.jp）として設定されています。そのため、大学のメールアドレスを使用する際には、**"姓-名@ed.tmu.ac.jp"**（例：shuto-dai@ed.tmu.ac.jp）と設定させるようにしてください。
