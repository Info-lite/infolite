...
情報リテラシー実践1の授業内容として、kibacoに**情リテ情報倫理テスト**が配置されておりますので、必ず受講し、合格するようにしてください。

**情リテ情報倫理テスト**の実施期間に関しては、授業を担当する教員によって違いますので、授業を担当する教員の支持に従ってください。

さらに本学では、情報リテラシー実践1の授業とは別に、<u>最低でも年に1回は、情報を安全に扱えるようになるために**情報セキュリティ研修**を受講し、テストに合格することが必須</u>となっています。
...
| 情報セキュリティ研修 | 4月末日 | kibaco-<br />情報セキュリティ研修コース内 | 本学全体における情報セキュリティの確認のための研修とテスト | 100点が取れるまで何回でも受験する。 |
