...
**関数**、**絶対参照と相対参照**は、Excelを初めとする表計算ソフトにおいて、とても重要な機能の1つです。
...
まず、各人のいちごの"合計(g)"を求めます。前回説明していますので、復習のつもりでやってみましょう。

&#9312; "F3" を選択します。

&#9313; 次に[ホーム]リボン - [編集]グループ - [オート SUM]をクリックします。
...
オートフィルを使って、全ての合計を出します。

&#9312; 選択したセルの右下にある[■]の上にカーソルを持って行き、一気に "F12" まで引き延ばします。
...
各人が平均でどのくらいのいちごを採ったのか、調べてみましょう。

&#9312; まず "E13" を選択し，`平均` と入力します。

&#9313; 次に、"F13" を選択します。[ホーム]リボン - [編集]グループ - [オートSUM]の[▼] - [平均]をクリックします。

{% screenshot average1.png "編集グループから平均を選択" %}
...
誰が一番食べたのかを、関数で出すことができます。

&#9312; "A3" を選択します。

&#9313; [ホーム]リボン - [編集]グループ - [オート SUM]の[▼] - [その他の関数]をクリックします。もしくは、[数式]リボン - [関数ライブラリ]グループ - [関数の挿入]をクリックします。

{% screenshot rank1.png "編集グループからその他の関数" %}
...
オートフィルを使って、各人の順位を出します。

&#9312; "A3" から "A12" まで伸ばします。

&#9313;  "A5" と "A6" 、 "A11" を見てください。`2` が３つあります（緑枠）。これは順位としておかしいので、修正しなくてはなりません。 "A12" を選択して、数式に注目してください。相対参照しているため、RANK.EQ関数の範囲がずれていることがわかります。（赤枠がA3の範囲、青枠がA12の範囲を表す）
...
&#9312; Gの列を選択して、右クリック - [挿入]をクリックします。 "G2" に `あまおう（円）` と入力します。

&#9313; 次に "G3" を選択します - [ホーム]リボン - [編集]グループ - [オートSUM]の[▼] - [その他の関数]をクリックします。もしくは、[数式]リボン - [関数ライブラリ]グループ - [関数の挿入]をクリックします。
...
&#9313; 次に、[挿入]リボン - [グラフ]グループ - [縦棒] - ![](pic/graphvertical.png) *集合縦棒* を選択します。
...
&#9313; 次に、"グラフツール" - [デザイン]リボン - [データ]グループ - [データの選択]をクリックします。
...
&#9312; まず、"グラフツール" - [デザイン]リボン - [グラフのスタイル]グループの ![](pic/other.png) *その他* をクリックします。
...
&#9312; まず、グラフタイトルを追加します。
"グラフツール" - [デザイン]リボン - [グラフの要素を追加]グループ - [グラフタイトル]をクリックしてください。この教材では[グラフの上]を選択しています。
...
&#9314; 次に軸ラベルを入力してみましょう。
"グラフツール" - [デザイン]リボン - [グラフ要素を追加]グループ - [軸ラベル]をクリックしてください。ここで各軸ラベルを設定できます。
...
&#9312; まず、"グラフツール" - [デザイン]リボン - [グラフの要素を追加]グループ - [誤差範囲]をクリックします。
...
グラフの書式は、基本的に"グラフツール" - [書式]リボン - [現在の選択範囲]グループ - [選択対象の書式設定]で変更することができます。

&#9312; まず、"グラフツール" - [書式]リボン - [現在の選択範囲]グループのプルダウンメニューを、変更したいものに変えます。（変更したいところをクリックしても変わります。）

{% screenshot graphdesign3.png "グラフの書式" %}

&#9313; 次に、"グラフツール" - [書式]リボン - [現在の選択範囲]グループ -[選択対象の書式設定]をクリックします。
...
グラフを選択し、[挿入]リボン - [グラフ]グループを用いてグラフの種類を変えます。

#### グラフの消去

グラフを選択して[Delete]キー、あるいは[ホーム]リボン - [編集]グループの ![](pic/clear.png) *クリア* の[すべてクリア]をクリックして消去します。
...
&#9314; 次に、グラフの気温の項目を選択（グラフ内の気温系列の棒要素をクリック）し、[挿入]リボン - [グラフ]グループ - [折れ線]の中の任意の折れ線を選びます。

{% screenshot graphtype6.png "グラフの種類の選択" %}

&#9315; さらに、気温の項目を選択したまま、"グラフツール" - [書式]リボン - [現在の選択範囲]グループ - [選択対象の書式設定]をクリックします。
...
&#9314; Excelにて対象表部分をドラッグして選択し、[ホーム]リボン - [クリップボード]グループの ![](pic/copy.png) *コピー* を選択します。あるいはショートカットキー（Windowsであれば[Ctrl]+[C]）を利用します。

{% screenshot copy1.png "" %}

&#9315; Wordの画面を表示させます。挿入したい位置にカーソルを置き、[ホーム]リボン - [クリップボード]グループの ![](pic/paste.png) をクリックします。あるいはショートカットキー（Windowsであれば[Ctrl]+[V]）を使います。
