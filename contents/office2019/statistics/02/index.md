...
<video>
<source type="video/mp4" src="../../../../../lit/video/st02_sample.mp4">
</video>
</div>
</div>
</div></div>
...
$\bar{x}$は標本平均、$\mu_0$ は母平均、$s$ は標本の標準偏差、$n$ は標本の大きさ（サンプルサイズ）です。
