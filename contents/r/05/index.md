...
{% screenshot 04_practice2_chi2.png " " %}
...
$p$値 = 3.223×10<sup>-5</sup>が求まりました。  
<br />
$p$値 = 3.223×10<sup>-5</sup> &lt; 有意水準α = 0.05 なので、帰無仮説H<sub>0</sub>は棄却されます。 よって、鍋の種類の好みは年代によって異なるといえます。
