...
&#9313; [外部データ]リボン - [新しいデータソース] - [ファイルから] - [Excel]をクリックします。

{% screenshot excelimport1-2025.png "Excelアイコンの場所" %}
...
&#9312; [外部データ]リボン - [新しいデータソース] - [データベースから] - [Access]をクリックします。

{% screenshot accessimport1-2025.png "Accessアイコンの場所" %}
