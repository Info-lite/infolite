...
![並べ替え](pic/06_05rank.png)

出力結果

性別を基準に、身長・足のサイズもともに並べ替えられています。

![出力結果](pic/06_06rank.png)
...
![散布図](pic/06_07man.png)

&#9313; このようなグラフが出来上がります。

![散布図](pic/06_08man.png)

&#9314; 女性でも同様に散布図を作成します。

![散布図](pic/06_09women.png)

&#9315; 男性のグラフを選択した状態で、グラフツールの[デザイン]リボンの[データの選択]をクリックします。

![凡例の変更](pic/06_10legend.png)

&#9316; 凡例項目で足のサイズが選択されていることを確認し、[編集(E)]をクリックします。

![凡例の変更](pic/06_11legend.png)

&#9317; 系列名に"男性"と入力し、決定します。

![凡例の変更](pic/06_12legend.png)

&#9318; 男性のグラフをコピーし、女性のグラフ上に貼り付けます。

![散布図](pic/06_13scatter.png)
...
![無相関検定](pic/06_40no.png)

出力結果

![無相関検定](pic/06_41no.png)
