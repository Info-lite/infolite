...
![並べ替え](pic/06_04rank.png)

&#9313; 最優先されるキーを[性別]と選択し、以下の設定で並べ替えを実行します。

![並べ替え2](pic/06_05rank.png)

出力結果

性別を基準に、身長・足のサイズもともに並べ替えられています。

![並べ替えの出力結果](pic/06_06rank.png)
...
![散布図1](pic/06_07man.png)

&#9313; このようなグラフが出来上がります。

![散布図2](pic/06_08man.png)

&#9314; 女性でも同様に散布図を作成します。

![散布図3](pic/06_09women.png)

&#9315; 男性のグラフを選択した状態で、グラフツールの[デザイン]リボンの[データの選択]をクリックします。

![凡例の変更1](pic/06_10legend.png)

&#9316; 凡例項目で足のサイズが選択されていることを確認し、[編集(E)]をクリックします。

![凡例の変更2](pic/06_11legend.png)

&#9317; 系列名に"男性"と入力し、決定します。

![凡例の変更3](pic/06_12legend.png)

&#9318; 男性のグラフをコピーし、女性のグラフ上に貼り付けます。

![散布図4](pic/06_13scatter.png)
...
![データ分析の説明](pic/06_26r.png)

&#9314; [相関]を選択し[OK]をクリックします。

![相関分析1](pic/06_27r.png)
...
![相関分析2](pic/06_28r.png)

出力結果

![相関分析3](pic/06_29r.png)
...
![相関分析4](pic/06_30r.png)

出力結果

![相関分析の出力結果](pic/06_31r.png)
...
![count](pic/06_36count.png)

出力結果

![countの出力結果](pic/06_37count.png)
...
![TDIST関数](pic/06_40no.png)

出力結果

![TDIST関数の出力結果](pic/06_41no.png)
