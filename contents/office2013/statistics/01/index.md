...
![例題1](pic/01_06exQ1.png)

### データの入力

&#9312; Excelを開き，以下のようにデータを入力してください。

![表1](pic/01_07table01.png)

### 合計の計算

&#9312; 合計を計算します。"C2"セルに `=A2+B2` と半角で入力します。

![合計1](pic/01_08table02.png)

![合計2](pic/01_09table03.png)

&#9313; オートフィルを使って、全ての合計を出します。選択したセルの右下にある[■]の上にカーソルを持って行き、一気に"C21"まで引き延ばします。

![合計のオートフィル1](pic/01_10table04.png)

&#9314; 合計が計算できました。

![合計のオートフィル2](pic/01_11table05.png)
...
![基本統計量の手計算](pic/01_13table07.png)

&#9314;  オートフィルを使って、算数と合計についても基本統計量を求めます。"F2" から "F14" まで選択し，右下にある[■]をドラッグして "H14" まで引き延ばします。

![基本統計量の手計算 - オートフィル1](pic/01_14table08.png)

&#9315; 算数と合計の基本統計量が求められました。

![基本統計量の手計算 - オートフィル2](pic/01_15table09.png)
...
![データ分析](pic/02_01data1.png)

&#9313; "基本統計量"を選択し，[OK]をクリックします。

![基本統計量1](pic/02_04data3.png)
...
![基本統計量2](pic/02_05data4.png)

&#9318; [OK]を押すと基本統計量が出力されます。

![基本統計量3](pic/02_06table2.png)
...
![表1:東京23区の各区の面積(平方キロメートル)](pic/02_07exQ2_1.png)

表2:階級

![表2:階級](pic/02_08exQ2_2.png)
...
![ヒストグラム2](pic/02_11data6.png)

&#9318; [OK]を押すと度数分布表とヒストグラムが出力されます。

![ヒストグラム3](pic/02_12table4.png)
