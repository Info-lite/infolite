...
![アウトライン](pic/word03_20outline.png)
...
以下の箇所について、[挿入]リボン - "ページ" - [ページ区切り]を押してページ区切りを挿入します。
...
&#9316; 目次までを先頭のページとして、"1. 街の説明"を次のページになるよう、[改ページ]を入れます。
...
&#9318; ここで[目次の更新]を押すと、目次のページ番号が自動修正され、実際のページ数を反映したものになります。

![](pic/word03_39index.png)

[目次] - [ユーザー設定の目次]を押すと、詳細な設定を行った目次を挿入することができます。
